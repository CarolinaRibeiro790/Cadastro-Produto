...
public class EditarView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtCodigoPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    int codigo = Integer.parseInt(txtCodigoPesquisar.getText());
    
    SupermercadoController supermercadoController = new SupermercadoController();
    List<Object> dadosProduto = supermercadoController.pesquisar(codigo);
    
    if(dadosProduto != null) {
        txtCodigo.setText(dadosProduto.get(0).toString());
        txtNome.setText((String) dadosProduto.get(1));
        txtDescricao.setText((String) dadosProduto.get(2));
        txtPreco.setText(dadosProduto.get(3).toString());
        txtQtd.setText(dadosProduto.get(4).toString());
        
        // Calcula o valor total do produto e exibe no campo txtValorTotal
        float preco = Float.parseFloat(dadosProduto.get(3).toString());
        float quantidade = Float.parseFloat(dadosProduto.get(4).toString());
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        SupermercadoController supermercadoController = new SupermercadoController();
        supermercadoController.editar(codigo, nome, descricao, preco, quantidade, valor);
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
         try {
            float preco = Float.parseFloat(txtPreco.getText()); // Pega o preço atualizado
            float quantidade = Float.parseFloat(txtQtd.getText()); // Pega a quantidade atualizada
            float valorTotal = preco * quantidade; // Calcula o novo valor total
           
             txtValorTotal.setText(String.valueOf(valorTotal));
        } catch (NumberFormatException e) {
            // Tratamento de erro caso os campos não sejam válidos
            JOptionPane.showMessageDialog(null, "Por favor, insira valores válidos para preço e quantidade.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
